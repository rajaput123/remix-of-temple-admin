...
import ServicesListPage from "./pages/business/services/ServicesList";
import ServiceDetailPage from "./pages/business/services/ServiceDetail";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/business/profile/*" element={<Navigate to="/business/profile" replace />} />
