...
const sidebarItems = [
  { label: "Overview", icon: LayoutDashboard, path: "/domain/tenants/overview", description: "Dashboard with tenant metrics and health monitoring" },
  { label: "All Tenants", icon: Building2, path: "/domain/tenants/all", description: "Manage all active temple SaaS accounts" },
  { label: "Subscription Plans", icon: CreditCard, path: "/domain/tenants/plans", description: "Configure global subscription plans and pricing" },
  { label: "Usage Monitoring", icon: Activity, path: "/domain/tenants/usage", description: "Track usage across all tenants and enforce limits" },
  { label: "Suspension & Compliance", icon: ShieldAlert, path: "/domain/tenants/suspension", description: "Handle suspensions and compliance issues" },
  { label: "Region Management", icon: Globe, path: "/domain/tenants/regions", description: "Manage regional settings and segmentation" },
  { label: "Tenant Logs", icon: FileText, path: "/domain/tenants/logs", description: "View complete audit trail of tenant actions" },
];
