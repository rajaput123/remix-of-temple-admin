...
export default function BCAuth() {
  ...
  function verifyMobile(e: React.FormEvent) {
    e.preventDefault();
    if (!otpSent) {
      sendOtp();
      return;
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-[0_10px_40px_-12px_rgba(15,23,42,0.12)] p-8 sm:p-10">
            ...
            <form onSubmit={verifyMobile} className="space-y-4">
              <div className="space-y-1.5">
                <label htmlFor="mobile" className="block text-[11px] font-semibold tracking-wider text-slate-500">
                  MOBILE NUMBER
                </label>
                <Input
                  id="mobile"
              ...
              {otpSent && (
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    <label htmlFor="otp" className="block text-[11px] font-semibold tracking-wider text-slate-500">
                      OTP
                    </label>
                    <button
                      type="button"
