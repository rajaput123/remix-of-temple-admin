...
const moduleOverviews: Record<string, {
  ...
  donations: {
    ...
    kpis: [
      ...
      { label: "80G Issued", value: "312", trend: "+15%", color: "text-blue-600" },
    ],
  ...
  events: {
    ...
    kpis: [
      { label: "Total Events", value: "24", trend: "+6", color: "text-blue-600" },
  ...
  finance: {
    ...
    kpis: [
      ...
      { label: "Budget Utilization", value: "72%", trend: "On track", color: "text-blue-600" },
    ],
  ...
  offerings: {
    ...
    kpis: [
      ...
      { label: "Unique Devotees", value: "1,120", trend: "+12%", color: "text-blue-600" },
    ],
  ...
  projects: {
    ...
    kpis: [
      ...
      { label: "On-time Rate", value: "85%", trend: "+5%", color: "text-blue-600" },
    ],
  ...
  branches: {
    ...
    kpis: [
      ...
      { label: "Compliance", value: "94%", trend: "+3%", color: "text-blue-600" },
    ],
  ...
  institutions: {
    ...
    kpis: [
      { label: "Institutions", value: "4", trend: "Active", color: "text-blue-600" },
  ...
  hr: {
    ...
    kpis: [
      ...
      { label: "Expense Claims", value: "₹4.2L", trend: "+6%", color: "text-blue-600" },
    ],
  ...
  vip: {
    ...
    kpis: [
      ...
      { label: "Events Attended", value: "342", trend: "+18%", color: "text-blue-600" },
    ],
  ...
  devotees: {
    ...
    kpis: [
      ...
      { label: "Avg Engagement", value: "72%", trend: "+5%", color: "text-blue-600" },
    ],
  ...
  communication: {
    ...
    kpis: [
      ...
      { label: "Devotees Reached", value: "890", trend: "+18%", color: "text-blue-600" },
